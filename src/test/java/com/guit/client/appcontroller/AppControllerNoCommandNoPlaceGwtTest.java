...
public class AppControllerNoCommandNoPlaceGwtTest extends GWTTestCase {

  private static ControllerNoCommandNoPlace controller;

  public static class ControllerNoCommandNoPlace extends
      GuitController<ControllerNoCommandNoPlaceBinder> {
  ...
  public static interface ControllerNoCommandNoPlaceBinder extends
      GuitBinder<ControllerNoCommandNoPlace> {
  }
  ...
  public String getModuleName() {
    return "com.guit.AppControllerNoCommandNoPlaceModule";
  }
  ...
  public void testCommandAndPlaceAreMocked() {
    assertTrue(controller.getEventBus() instanceof SimpleEventBus);
    assertTrue(controller.getPlaceManager() instanceof PlaceManagerMock);
    assertTrue(controller.getCommandService() instanceof CommandServiceMock);
  }
}
