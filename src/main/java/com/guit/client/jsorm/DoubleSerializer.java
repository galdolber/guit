...
public class DoubleSerializer extends AbstractSerializer<Double> {
  ...
  public static DoubleSerializer getSingleton() {
    return singleton == null ? (singleton = new DoubleSerializer()) : singleton;
  }
  ...
  @Override
  protected JSONValue serializeJson(Double data) {
