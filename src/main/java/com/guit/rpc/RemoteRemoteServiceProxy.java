...
public abstract class RemoteRemoteServiceProxy extends RemoteServiceProxy {
  ...
  private RemoteServiceUrl url = GWT.create(RemoteServiceUrl.class);
  ...
  protected RemoteRemoteServiceProxy(String moduleBaseURL, String remoteServiceRelativePath,
  ...
  protected <T> Request doInvoke(final ResponseReader responseReader, final String methodName,
    ...
    builder.requestString(remoteUrl + "?a=" + URL.encode(requestData), new AsyncCallback<String>() {
      @Override
