...
public interface CommandRpcAsync {
  ...
  void execute(Action<Response> action, AsyncCallback<Response> response);

  void executeBatch(ArrayList<Action<Response>> actions, AsyncCallback<BatchResponse> callback);
}
