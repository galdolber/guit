...
import com.guit.client.binder.TestPresenter.TestBinder;
...
@Singleton
public class TestPresenter extends GuitPresenter<TestBinder> implements HasUserActionValue {
  ...
  @Implementation(TestAccesorImpl.class)
  public static interface TestAccesor extends ViewAccesor {
    Object getTarget();
  }

  public static class TestAccesorImpl implements TestAccesor {
  ...
  public static interface TestBinder extends GuitBinder<TestPresenter> {
  }
  ...
  @ViewField
  TestAccesor trueElement;

  @ViewField
  TestAccesor falseElement;
